Pracsquad.create!([
  ...
  { name: 'Trey Sermon', number: '27', position: 'RB', exp: 3, status: 'Practice Squad', college: 'Ohio State', photo: 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4241401.png&w=350&h=254' },
