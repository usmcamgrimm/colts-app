Injured.create!([
  ...
  { name: 'Evan Hull', number: '26', position: 'RB', exp: 0, status: 'Active', college: 'Northwestern', photo: 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4569609.png&w=350&h=254' },
